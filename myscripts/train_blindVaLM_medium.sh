...
CKPT_DIR=./CHECKPOINTS/checkpoint_blindVaLM_medium_40600upd
DATASTORE_DIR=./data/image_features_datastore
K=4

srun torchrun --nproc_per_node=8 fairseq/fairseq_cli/train.py \
    ${DATA_DIR}/0:${DATA_DIR}/1:${DATA_DIR}/2:${DATA_DIR}/3:${DATA_DIR}/4:${DATA_DIR}/5 \
    --save-dir ${CKPT_DIR} --task language_modeling --arch transformer_lm_gpt2_small --share-decoder-input-output-embed \
    ...
    --sample-break-mode none --max-tokens 32768 --max-update 40600 --save-interval-updates 10000 \
